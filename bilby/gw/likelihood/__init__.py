...
from .base import TDGravitationalWaveTransient
from .base import TDCovGravitationalWaveTransient
...
def get_td_binary_black_hole_likelihood(interferometers):
    """ A wrapper to quickly set up a likelihood for BBH parameter estimation
    ...
    Returns
    =======
    bilby.TDGravitationalWaveTransient: The time-domain likelihood to pass to `run_sampler`
    ...
    waveform_generator = WaveformGenerator(
        ...
        waveform_arguments={'waveform_approximant': 'IMRPhenomPv2',
                            'reference_frequency': 50})
    return TDGravitationalWaveTransient(interferometers, waveform_generator)

def get_td_cov_binary_black_hole_likelihood(interferometers):
    """ A wrapper to quickly set up a likelihood for BBH parameter estimation
    ...
    waveform_generator = WaveformGenerator(
        ...
        waveform_arguments={'waveform_approximant': 'IMRPhenomPv2',
                            'reference_frequency': 50})
    return TDCovGravitationalWaveTransient(interferometers, waveform_generator)