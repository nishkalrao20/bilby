...
from ..utils import noise_weighted_inner_product, td_noise_weighted_inner_product, zenith_azimuth_to_ra_dec, ln_i0
...
class TDGravitationalWaveTransient(Likelihood):
    ...
    def _calculate_inner_products(self, signal_polarizations):
        ...
        for interferometer in self.interferometers:
            ...
            d_inner_h += per_detector_snr.d_inner_h
            h_inner_h += per_detector_snr.td_optimal_snr_squared
        return d_inner_h, h_inner_h
