...
class TDGravitationalWaveTransient(Likelihood):
    """ A gravitational-wave transient likelihood object in the time domain

    This is the usual likelihood object to use for transient gravitational
    wave parameter estimation in time domain. It computes the log-likelihood in the 
    time domain. 
    ...
    waveform_generator: `bilby.waveform_generator.WaveformGenerator`
        An object which computes the time-domain strain of the signal,
